...
int main()
{
	...
	for (;;)
	{
		...
		cout << "5 - вывод числа колизий" << endl;
		cout << "6 - сброc счетичка колизий" << endl;
		cout << "0 - выход" << endl;
		...
		case 5:
		{
			cout << endl << "Число коллизий через модульное хеширование : " << modulColision << endl;
			cout << endl << "Число коллизий через мультипликативное хеширование : " << MultColision << endl;
		}
		break;
		case 6:
		{
